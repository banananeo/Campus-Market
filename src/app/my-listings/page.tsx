...
export default function MyListingsPage() {
    ...
    async function updateStatus(
        ...
        if (error) {
            console.error(error)
            alert("Could not update the listing status.")
            setUpdatingId(null)
            return
        }
                                ...
                                >
                                    ...
                                    <div className="relative h-52 border-b-[4px] border-black">
                                        ...
                                        <div className="absolute right-3 top-3">
                                            <span
                                                className={`badge-brutal ${getStatusClass(
                                                    listing.status
                                                )}`}
                                            >
                                                {getStatusLabel(
                                    ...
                                    <div className="flex flex-1 flex-col p-5">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <label className="mb-2 block font-mono text-[10px] font-bold uppercase tracking-widest">
                                                Listing Status
                                            </label>
                                            ...
                                            <select
                                                ...
                                                className="w-full border-[3px] border-black bg-white px-3 py-2 font-mono text-xs font-bold uppercase outline-none"
                                            >
